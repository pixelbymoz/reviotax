      ...
      <div className="px-4 py-4 border-t border-gray-200">
        <div className="bg-gray-50 rounded-lg p-4">
          ...
          <button  onClick={() => window.open("https://pajak.go.id/id", "_blank")}
            className="w-full flex items-center justify-center gap-2 bg-teal-500 text-white text-xs font-medium py-2 px-3 rounded-md hover:bg-teal-600 transition-colors">
